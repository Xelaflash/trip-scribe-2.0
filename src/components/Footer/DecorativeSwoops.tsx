...
const Blocker = () => {
  return (
    <svg
      ...
      className="absolute inset-[calc(var(--stroke-width)*-1)] h-4/5 w-[calc(100%+4px)] min-w-[800px] max-w-none [&_path]:fill-surface [&_path]:stroke-[length:var(--stroke-width)] [&_path]:stroke-[var(--stroke-color)]"
      preserveAspectRatio="none"
    >
      <path
        className="fill-surface stroke-[var(--stroke-color)] [stroke-width:var(--stroke-width)]"
